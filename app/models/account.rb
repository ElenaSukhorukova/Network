...
class Account < ApplicationRecord
  ...
  has_many :sender_message, class_name: 'Message',
                            foreign_key: :sender_message_id,
                            inverse_of: :sender_message, dependent: :destroy

  has_many :recipient_message, class_name: 'Message',
                               foreign_key: :recipient_message_id,
                               inverse_of: :recipient_message, dependent: :destroy

  has_many :f_partner_conversation, class_name: 'Conversation',
                                    foreign_key: :f_partner_conversation_id,
                                    through: :sender_message, source: :sender_message,
                                    inverse_of: :f_partner_conversation, dependent: :destroy

  has_many :s_partner_conversation, class_name: 'Conversation',
                                    foreign_key: :s_partner_conversation_id,
                                    through: :reciepient_message, source: :sender_message,
                                    inverse_of: :s_partner_conversation, dependent: :destroy
  ...
  has_many :groups, class_name: 'Group', foreign_key: :group_creator_id,
  ...
  has_many :f_partner_friendships, class_name: 'Friendship',
                                   ...
                                   inverse_of: :friendship, dependent: :destroy
